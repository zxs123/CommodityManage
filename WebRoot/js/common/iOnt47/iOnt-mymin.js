...
K.options = {
	...
	loadStyleMode : true,
	basePath : K.basePath,
	themesPath : K.basePath + 'xemes/',
	langPath : K.basePath + 'xang/',
	pluginsPath : K.basePath + 'xins/',
	themeType : 'default',
	langType : 'zh_CN',
	urlType : '',
	newlineTag : 'p',
...
function _create(expr, options) {
	...
	options.themesPath = _undef(options.themesPath, options.basePath + 'xemes/');
	options.langPath = _undef(options.langPath, options.basePath + 'xang/');
	options.pluginsPath = _undef(options.pluginsPath, options.basePath + 'xins/');
